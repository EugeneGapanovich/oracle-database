...
ALTER TABLE PLAYER_STATISTICS ADD CONSTRAINT SEASONDS_ID_FK FOREIGN KEY(SEASONS_ID) REFERENCES SEASONS(SEASONS_ID) ON DELETE SET NULL;
CREATE INDEX SEASONDS_ID_FK_IDX ON PLAYER_STATISTICS (SEASONS_ID) TABLESPACE &&INDEX_TABLESPACE_NAME;	
...
ALTER TABLE TRANSFERS ADD CONSTRAINT TRANSFERS_SEASON_ID_FK FOREIGN KEY(SEASON_ID) REFERENCES SEASONS(SEASONS_ID) ON DELETE SET NULL;
